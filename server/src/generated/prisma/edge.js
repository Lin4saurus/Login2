...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\PROYECTOS\\Login2\\server\\src\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "moduleFormat": "cjs",
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\PROYECTOS\\Login2\\server\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "postgresql://koori:koori123@localhost:5431/login2bd"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider     = \"prisma-client-js\"\n  output       = \"../src/generated/prisma\"\n  moduleFormat = \"cjs\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = \"postgresql://koori:koori123@localhost:5431/login2bd\"\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  name      String\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "d7ef703626642dc68229d31eea7b5237b92b2f8102aae317ee69680014c05b16",
  "copyEngine": true
}
config.dirname = '/'
